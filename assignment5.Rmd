...
#I will remove the PC5 and PC6 since they only account for a small proportion of the variance
...
```
#We would lost valuable information if drop PC5 and PC6. Because the correlation between PC6 and mean correct is -0.393, which is not small comparing to others.
